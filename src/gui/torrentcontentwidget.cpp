...
void TorrentContentWidget::setFilterPattern(const QString &patternText, FilterPatternMode mode)
{
    if (mode == FilterPatternMode::PlainText)
    {
    ...
    {
        const QString pattern = ((mode == FilterPatternMode::Regex)
